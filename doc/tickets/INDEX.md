...
**Версия:** 1.2  
**Дата:** 2026-09-22  
**Всего фаз:** 29 (8 завершено + 1 в работе, 20 осталось)
...
|--------|----------|------------|
| ✅ Завершено | Фаза реализована и смержена в main | 8 |
| 🚧 В работе | PR готов или в процессе | 1 |
| 📋 Детальный тикет | Полный тикет по шаблону готов | 8 |
| 📝 Краткое описание | Есть только краткое описание | 12 |
| ⏳ Не начато | Ещё не планировалось | 0 |
...
- **Статус:** В работе (ветка feature/phase-11-remarks-lifecycle)
- **SP:** 8
...
## Группа E: Создание процессов из шаблонов (🔴 Критический путь до MVP)

### PHASE-14: Шаблоны маршрутов 📋
- **Тикет:** [PHASE-14-template-management.md](PHASE-14-template-management.md)
- **Статус:** Детальный тикет готов ⭐ **Рекомендуется следующей**
- **SP:** 13
- **Зависимости:** PHASE-04 ✅
- **Что входит:** TemplateService (CRUD), TemplateStateMachine, версионирование (ADR-023), Fork & Drain
- **Следующий шаг:** Реализация (критично для MVP)

### PHASE-15: Подбор шаблона и генерация маршрута 📋
- **Тикет:** [PHASE-15-route-generation.md](PHASE-15-route-generation.md)
- **Статус:** Детальный тикет готов (самая большая фаза, 21 SP)
- **SP:** 21
- **Зависимости:** PHASE-14
- **Что входит:** MatchService (подбор по ApplicabilityRule), RouteGeneratorService, резолвинг слотов, RoleResolverAdapter (stub), валидация
- **Следующий шаг:** Реализация после PHASE-14 (завершает MVP)
...
- **Тикет:** [PHASE-21-25-REST-API.md](PHASE-21-25-REST-API.md)
- **Статус:** Детальный тикет готов ⭐ **Критический путь до MVP с UI**
- **SP:** 27 (объединённые фазы 21-25, без зависимости от PHASE-17/18)
- **Зависимости:** PHASE-15 (генерация), PHASE-08 (возврат), PHASE-11 (замечания), PHASE-14 (шаблоны)
- **Что входит:** 
  - ProcessController (создание/запуск/отзыв/возобновление)
  - DecisionController (принятие решений)
  - RemarkController, CommentController (замечания)
  - TemplateController (управление шаблонами)
  - StateMachineConfigController, GuardActionRegistryController (реестры)
  - AdminController (восстановление из архива, **без PHASE-17/18**)
  - ApprovalViewController (агрегированные эндпоинты)
- **Следующий шаг:** Реализация после PHASE-14 и PHASE-15

### PHASE-29: REST API — Настройки уведомлений и автоархивации 📝
- **Тикет:** Будет создан отдельно
- **Статус:** Отложено до PHASE-17, PHASE-18
- **SP:** 3 (оценка)
- **Зависимости:** PHASE-17 (напоминания), PHASE-18 (автоархивация)
- **Что входит:** NotificationSettingsController, AutoArchiveConfigController
- **Следующий шаг:** Подготовить тикет после реализации PHASE-17/18

...
class AggregationReworkGuardTest {

    private DecisionRepository decisionRepository;
    private AggregationReworkGuard guard;

    @BeforeEach
    void setUp() {
        decisionRepository = mock(DecisionRepository.class);
        guard = new AggregationReworkGuard(decisionRepository);
    }

    @Test
    void returnsTrueForAndModeWithOneReject() {
    ...
    @Test
    void returnsFalseForAndModeWithAllApprove() {
        StageInstance stage = createStageWithDecisions(
                DecisionMode.AND,
    ...
    @Test
    void returnsTrueForAnyApproveModeWithAllReject() {
        StageInstance stage = createStageWithDecisions(
    ...
    @Test
    void returnsFalseForAnyApproveModeWithOneApprove() {
        StageInstance stage = createStageWithDecisions(
                DecisionMode.ANY_APPROVE,
    ...
    @Test
    void returnsTrueForAnyRejectModeWithOneReject() {
        StageInstance stage = createStageWithDecisions(
    ...
    @Test
    void returnsFalseForAnyRejectModeWithNoReject() {
        StageInstance stage = createStageWithDecisions(
                DecisionMode.ANY_REJECT,
                List.of("APPROVE", "APPROVE", "APPROVE"));
    ...
    @Test
    void returnsFalseForAnyDecisionMode() {
        StageInstance stage = createStageWithDecisions(
    ...
    @Test
    void returnsTrueForFirstRejectFailFastModeWithOneReject() {
        StageInstance stage = createStageWithDecisions(
    ...
    @Test
    void returnsFalseForFirstRejectFailFastModeWithAllApprove() {
        StageInstance stage = createStageWithDecisions(
                DecisionMode.FIRST_REJECT_FAIL_FAST,
                List.of("APPROVE", "APPROVE", "APPROVE"));
